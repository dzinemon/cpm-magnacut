/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: baedeef37dcd69d9ee5cd2d3511b1637)
// Runtime types generated with workerd@1.20260111.0 2025-12-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXTJS_ENV: string
		WORKER_SELF_REFERENCE: Fetcher /* cpm-magnacut */
