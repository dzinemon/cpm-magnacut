...
export const ProductHero = () => {
	...
	return (
		<section className="sm:min-h-screen relative flex items-center justify-center overflow-hidden bg-brand-black text-white pt-0 pb-12 lg:pt-20 lg:pb-20">
			...
			<div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-12 items-center w-full z-10">
				{/* Left Side: Info */}
				<div className="flex flex-col gap-3 lg:gap-6 order-2 md:order-1">
					<motion.div
					...
					>
						<h1 className="text-6xl sm:text-6xl md:text-7xl lg:text-8xl font-condensed font-bold tracking-tighter uppercase leading-none">
							...
							<div className="text-transparent bg-clip-text bg-gradient-to-r from-white to-white/50">
								{["M", "0", "1"].map((char, index) => {
									return (
										<motion.div
											...
											transition={{
												duration: 1.2,
												delay: "vanguard".length * 0.1 + index * 0.1,
											}}
											className="inline-block"
										>
											{char}
					...
					>
						...
						<span className="text-neutral-400 font-mono text-xs lg:text-sm">
							48 Verified Reviews
						</span>
					</motion.div>
					...
					<div className="d-flex">
						<motion.div
							...
							className="text-2xl lg:text-4xl font-light font-mono"
						>
							$375.00
						</motion.div>
					</div>
					...
					>
						{/* Sold Out Badge */}
						<div className="inline-flex items-center gap-2 bg-red-500/10 border border-red-500/20 px-3 py-1.5 lg:px-4 lg:py-2 self-start">
							<span className="w-1.5 h-1.5 lg:w-2 lg:h-2 bg-red-500 rounded-full animate-pulse" />
							<span className="text-red-400 font-mono text-xs lg:text-sm uppercase tracking-wide">
								Sold Out — Batch 001 Fully Allocated
							</span>
						</div>

						{/* Notify Box */}
						<div className="bg-white/5 border border-white/10 p-4 lg:p-6 max-w-md">
							...
							<button
								...
								className="w-full bg-safety-orange hover:bg-orange-600 text-white px-4 py-3 lg:px-6 lg:py-4 text-sm lg:text-base font-bold tracking-wide uppercase transition-colors cursor-pointer flex items-center justify-center gap-2"
							>
				...
				<motion.div
					...
					className="relative h-[35vh] sm:h-[40vh] lg:h-[70vh] w-full order-1 md:order-2 flex items-center justify-center animate-float"
				>
